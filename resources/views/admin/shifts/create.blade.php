...
@section('title', 'Tambah Shift - Absensi PPNPN')
            ...
            <form action="{{ route('admin.shifts.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" value="{{ old('name') }}" required
                        placeholder="Contoh: Security Pagi">
                </div>
                ...
                <div class="form-group">
                    <div class="form-check p-3"
                        ...
                        <input class="form-check-input" type="checkbox" name="is_overnight" id="is_overnight" value="1" {{ old('is_overnight') ? 'checked' : '' }}>
                ...
                <div style="margin-top: 30px; text-align: right;">
                    <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Simpan Shift</button>
                </div>
            </form>
        </div>
    </div>
